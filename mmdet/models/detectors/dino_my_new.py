...
from .deformable_detr_my_new import MyNewDeformableDETR, MultiScaleDeformableAttention


@MODELS.register_module()
class MyNewDINO(MyNewDeformableDETR):
    ...
    def init_weights(self) -> None:
        ...
        super(MyNewDeformableDETR, self).init_weights()
