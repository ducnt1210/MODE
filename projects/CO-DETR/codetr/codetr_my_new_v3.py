# Pass object mask to restorer and not touch detector
import copy
...
class MyNewCoDETRV3(BaseDetector):
    ...
    def __init__(
        ...
        super(MyNewCoDETRV3, self).__init__(
    ...
    def predict(self,
        ...
        # if return_enhanced_images: # This is for feature map plot
        #     return restored_fea, batch_data_samples 
