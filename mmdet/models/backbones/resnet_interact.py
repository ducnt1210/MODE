...
class ResNetInteract(BaseModule):
    """ResNet backbone.
    ...
    def __init__(self,
                 ...
                 pretrained=None,
                 init_cfg=None):
        super(ResNetInteract, self).__init__(init_cfg)
        ...
        for i, num_blocks in enumerate(self.stage_blocks):
            ...
            interacor_name = f'interactor{i+1}'
            interactor_block = InteractionBlock(self.inplanes, 768)
            self.add_module(interacor_name, interactor_block)
    ...
    def forward(self, x, l, l_mask):
        ...
        for i, layer_name in enumerate(self.res_layers):
            ...
            x = res_layer(x)
            interactor_block = getattr(self, f'interactor{i+1}')
            x = interactor_block(x, l, l_mask)
    ...
    def train(self, mode=True):
        ...
        freezed."""
        super(ResNetInteract, self).train(mode)
        self._freeze_stages()
