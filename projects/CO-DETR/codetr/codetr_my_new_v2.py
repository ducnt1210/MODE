# Pass language and lanugage mask to the detector but now fuse inside of backbone.
import copy
...
class MyNewCoDETRV2(BaseDetector):
    ...
    def __init__(
        ...
        super(MyNewCoDETRV2, self).__init__(
        ...
        self.feat_enhancer = feat_enhancer
    ...
    def extract_feat(self, batch_inputs: Tensor, l: Tensor = None, l_mask: Tensor = None) -> Tuple[Tensor]:
        ...
        if self.feat_enhancer:
            x = self.backbone(batch_inputs, l, l_mask)
        else:
    ...
    def loss(self, batch_inputs: Tensor,
        ...
        if self.feat_enhancer:
            ...
            x = self.extract_feat(restored_fea, embeddings, embedding_masks)
        else:
    ...
    def predict(self,
        ...
        if self.feat_enhancer:
            ...
            # l2 = embeddings[:, :, max_seq_len_1:]
            # l2_mask = embedding_masks[:, max_seq_len_1:, :]
            img_feats = self.extract_feat(restored_fea, embeddings, embedding_masks)
        else:
